    ...
    <div className="main">
      <div className="about-container">
        ...
        <p className="about-description">
          ...
          beauty salons and barbershops. Developed by programmers Qasem and
          Rena, our goal is to provide a seamless and efficient booking
          experience for both clients and salon staff.
        </p>
